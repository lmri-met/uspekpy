...
class TestParseBeamParameters:
    ...
    def test_invalid_dataframe():
        # Create an invalid DataFrame with missing columns for testing
        data = {
            'Al filter width (mm)': [1.0],
            'Al filter width uncertainty': [0.1]
        }
        ...
        # Call the function with the DataFrame and expect it to raise a KeyError
...
class TestOutputDigest:
    ...
    def test_output_digest():
        # Create input DataFrame containing simulation parameters
        input_data = {
        ...
        # Create output DataFrames containing simulation results
        output_data1 = {
